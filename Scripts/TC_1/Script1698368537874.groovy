...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/button_Ingresar'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/span_Paul Collings'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/div_Time at WorkPunched InPunched In Jan 16_de1846'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/i_oxd-icon bi-caret-down-fill oxd-userdropd_f47aa9'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/a_Cerrar sesin'))
